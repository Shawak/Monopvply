...
class Monopvply {
    ...
    constructor(game, players) {
        ...
        this.fields = [
            ...
            new Street(id++, 'Metin2', 'img/streets/7_major_3/2_metin_2.jpg', 0, 'brown', 120, 50, 50),
            new CommunityField(id++, 'img/events/2_community.jpg'),
            new Street(id++, 'Flyff', 'img/streets/7_major_3/1_flyff.jpg', 0, 'brown', 140, 50, 50),
            ...
            new Street(id++, 'Nostale', 'img/streets/2_mmorpg/1_nostale.jpg', 1, 'lightblue', 200, 50, 50),
            new ActionField(id++, 'img/events/1_action.jpg'),
            new Street(id++, 'Last Chaos', 'img/streets/2_mmorpg/2_last_chaos.jpg', 1, 'lightblue', 200, 50, 50),
            new Street(id++, 'Tera', 'img/streets/2_mmorpg/3_tera.jpg', 1, 'lightblue', 240, 50, 50, 120),

            new Field(id++, 'Prison', 'img/corner/2_prison.jpg'),
            new Street(id++, 'General Gaming', 'img/streets/1_gaming/1_general_gaming.jpg', 2, 'pink', 240, 100, 100),
            new TaxField(id++, 'Pay more taxes!', 'img/events/3_tax.jpg', '#ff471a', 300),
            new Street(id++, 'Console Games', 'img/streets/1_gaming/2_consoles.jpg', 2, 'pink', 280, 100, 100),
            new Street(id++, 'Browser Games', 'img/streets/1_gaming/3_browser_games.jpg', 2, 'pink', 320, 100, 100),
            new Station(id++, 'Luke', 'img/stations/2_luke.jpg', 10,  'red', 400, 'red'),
            new Street(id++, 'Battlefield', 'img/streets/3_shooter/1_battlefield.jpg', 3, 'orange', 240, 100, 100),
            new CommunityField(id++, 'img/events/2_community.jpg'),
            new Street(id++, 'Counter Strike', 'img/streets/3_shooter/2_counter_strike.jpg', 3, 'orange', 360, 100, 100),
            new Street(id++, 'Arma', 'img/streets/3_shooter/3_arma.jpg', 3, 'orange', 400, 200, 100),

            new Field(id++, 'Cash Out', 'img/corner/3_cash_out.jpg'),
            new Street(id++, 'Joining Epvp', 'img/streets/6_general/1_joining_epvp.jpg', 4, 'red', 440, 150, 150),
            new ActionField(id++, 'img/events/1_action.jpg'),
            new Street(id++, 'Complaint Area', 'img/streets/6_general/2_complaint_area.jpg', 4, 'red', 440, 150, 150),
            new Street(id++, 'Black Market Support', 'img/streets/6_general/3_the_black_market_support.jpg', 4, 'red', 480, 150, 150),
            new Station(id++, 'MrSm!th', 'img/stations/3_smith.jpg', 10,  'red', 400, 'red'),
            new Street(id++, 'World of Warcraft', 'img/streets/4_major_1/1_wow.jpg', 5, 'yellow', 520, 150, 150),
            new Street(id++, 'Diablo 3', 'img/streets/4_major_1/2_diablo_3.jpg', 5, 'yellow', 520, 150, 150),
            new TaxField(id++, 'Taxes! Taxes! Taxes!', 'img/events/3_tax.jpg', '#ff471a', 300),
            new Street(id++, 'League of Legends', 'img/streets/4_major_1/3_lol.jpg', 5, 'yellow', 560, 150, 150),

            new Field(id++, 'Busted!', 'img/corner/4_go_to_prison.jpg'),
            new Street(id++, 'Guild Wars 2', 'img/streets/5_major_2/1_guild_wars_2.jpg', 6, 'green', 600, 200, 200),
            new CommunityField(id++, 'img/events/2_community.jpg'),
            new Street(id++, 'Aion', 'img/streets/5_major_2/2_aion.jpg', 6, 'green', 600, 200, 200),
            new Street(id++, 'Star Wars: The Old Republic', 'img/streets/5_major_2/3_swtor.jpg', 6, 'green', 640, 200, 200),
            new Station(id++, 'Muddy Waters', 'img/stations/4_muddy_waters.jpg', 10, 'red', 400, 'red'),
            new ActionField(id++, 'img/events/1_action.jpg'),
            new Street(id++, 'Conquer Online', 'img/streets/8_major_4/1_conquer_online.jpg', 7, 'purple', 700, 200, 200),
            new TaxField(id++, 'Taxing!', 'img/events/3_tax.jpg', '#ff471a', 200),
            new Street(id++, 'Silkroad', 'img/streets/8_major_4/2_silkroad_online.jpg', 7, 'purple', 800, 200, 200),
        ];
    }
