...
function setUpStandardMap(queueManager, gameMap, informationMenu)
{
	...
	gameMap.addSideField(new Field(queueManager,3,-1,"./img/events/3_tax.jpg", "", "Pay your tax!", 400,0,0.9,0.9, undefined, "#ff471a"));
	
	gameMap.addSideField(new Field(queueManager,4,-1,"./img/stations/1_john_dread.jpg", "", "John Dread", 400,0,0.9,0.9, undefined, undefined, "red"));
	...
	gameMap.addSideField(new Field(queueManager,10,-1,"./img/events/3_tax.jpg", "", "Pay more taxes!", 300, 0,0.9,0.9, undefined, "#ff471a"));
	...
	gameMap.addSideField(new Field(queueManager,13,-1,"./img/stations/2_luke.jpg", "", "Luke", 400, 0,0.9,0.9, undefined, undefined, "red"));
	...
	gameMap.addSideField(new Field(queueManager,22,-1,"./img/stations/3_smith.jpg", "", "MrSm!th", 400, 0,0.9,0.9, undefined, undefined, "red"));
	...
	gameMap.addSideField(new Field(queueManager,25,-1,"./img/events/3_tax.jpg", "", "Taxes! Taxes! Taxes!", 300, 0,0.9,0.9, undefined, "#ff471a"));
	...
	gameMap.addSideField(new Field(queueManager,31,-1,"./img/stations/4_muddy_waters.jpg", "", "Muddy Waters", 400, 0,0.9,0.9, undefined, undefined, "red"));
	...
	gameMap.addSideField(new Field(queueManager,34,-1,"./img/events/3_tax.jpg", "", "Taxing!", 200, 0,0.9,0.9, undefined, "#ff471a"));
